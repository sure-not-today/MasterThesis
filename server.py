...
async def main():
    ...
    asyncio.create_task(fill_container(container_a, "A", 10))
        ...
        while True:
            ...
            if container_a.full_status:
                ...
                for client_addr, (reader, writer) in clients.items():
                    ...
                    msg = f"GOTO_{container_a.pos[0]}_{container_a.pos[1]}_{container_a.pos[2]}"
